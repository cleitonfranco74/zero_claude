...
Os dados da página vêm da planilha recalculada e das bases tratadas do projeto (`d1_agropecuaria.csv`, `d1_emprego_rais.csv`, `d1_empresas.csv`, `d1_comex.csv`, `d1_pib_vab.csv`, `d2_bioeconomia.csv`, `d6_financas.csv`, bases `d2_*`, `d3_*`, `d4_*`, `d5_*`, `painel_pantanal_norte.csv`, `painel_municipios_mt.csv`). 14 dos 16 indicadores internos têm dado; faltam AGR-04 (Censo Agro) e AGR-05 (diversificação das lavouras). As notas dos fatores externos são preliminares.
