...
Os dados da página vêm da planilha recalculada e das bases tratadas do projeto (`d1_agropecuaria.csv`, `d1_emprego_rais.csv`, `d1_empresas.csv`, `d1_comex.csv`, `d1_pib_vab.csv`, `d2_bioeconomia.csv`, `painel_pantanal_norte.csv`, `painel_municipios_mt.csv`). 13 dos 16 indicadores internos têm dado; faltam AGR-04 (Censo Agro), AGR-05 (diversificação das lavouras) e EST-05 (Siconfi). As notas dos fatores externos são preliminares.
